...
// Theme Import
import { getListItemStyle } from "src/assets/theme/Drawer";

// Firebase Import
import { useAuth } from 'src/interface/Firebase/requestAuth';

//Image Import
import DrawerHeaderImageWhite from "src/assets/img/Invoice Search App-White.png";
import DrawerHeaderImageBlack from "src/assets/img/Invoice Search App-Black.png";
...
export const DrawerMenu: React.FC<DrawerMenuProps> = ({ open, onClose, variant = "temporary", elevation = 1 }) => {
    ...
    const groupedRoutes = useMemo(() => ({  
        ...
        [t("Authentication")]: [routes[4], routes[5]]  
    }), [t]);
    ...
    }, [location.pathname, loading, updatePosition]);
