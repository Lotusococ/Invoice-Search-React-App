...
import { getAppBarStyle, getBreadcrumbHomeStyle, getBreadcrumbItemStyle, getHeaderTitleStyle, getMenuStyle } from "src/assets/theme/Header";

// Components Import
import SettingDrawer from "src/components/Drawer/Settings Drawer";
...
export const Header: React.FC<HeaderProps> = ({ onDrawerOpen, isMenuVisible }) => {
    ...
    // Search API Settings
    const [searchApi, setSearchApi] = React.useState("excelAPI");
    ...
    const handleAPIChange = (event: SelectChangeEvent<string>) => {
        ...
        if (newSearchApi === "excelAPI" || newSearchApi === "webAPI") {
                ...
                <Box display="flex" justifyContent="space-between" alignItems="center" width="100%">
                    <Box display="flex" flexDirection="column" justifyContent="center">
                        <Breadcrumbs aria-label="breadcrumb" sx={{ my: 0.5 }}>
                            <Link component={RouterLink} to="/dashboard" color="inherit" sx={{ display: "flex", alignItems: "center", fontSize: "small" }}>
